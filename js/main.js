 ...
 */
 var configs = (function () {
    ...
    Singleton.defaultOptions = {
        general_help: "HELP",
        ls_help: "Lists directory",
        cat_help: "Reads data from the file and gives their content as output",
        whoami_help: "Gives informations about your session",
        date_help: "Gives date",
        help_help: "Lists all help commands",
        clear_help: "Clear the terminal screen.",
        reboot_help: "Reboot the system.",
        cd_help: "Change the current working directory.",
        mv_help: "Move (rename) files.",
        welcome: "Welcome to Cemre Cevik! \n",
        internet_explorer_warning: "NOTE: I see you're using internet explorer, this website won't work properly.",
        welcome_file_name: "Welcome to my website !",
        invalid_command_message: "<value>: command not found.",
        reboot_message: "Preparing to reboot...\n\n3...\n\n2...\n\n1...\n\nRebooting...\n\n",
        permission_denied_message: "Unable to '<value>', permission denied.",
        sudo_message: "Uh uh uh! You didn't say the magic word!",
        file: "file",
        username: "Username",
        hostname: "Host",
        platform: "Platform",
        ...
        host: "cemrecevik.com",
        user: "guest",        
        about: "I am Cemre, backend developer but like to write code on different languages and environments. I have been working as backend engineer for 8 years and also have some frontend background. I am also a really good gamer which like RPG, MMORPG, FPS games. Lead guitarist at music band and also like to dance, big fan of lindy hop!",
        skills: "Java, Kotlin, Groovy, SQL and NoSQL databases, AWS, Spring Frameworks, Messaging Protocols, Events, TDD, Mockito, JUNIT, Git, Domain Driven Design, Event sourcing, CQRS",
        experiences: "Just Eat Takeaway (Current - Berlin), Outfittery GMBH (Berlin), Siemens (Istabul), ETIYA (Istabul), ETGi Group (Ankara)",
        is_root: false,
        type_delay: 20
    };
    return {
...
var main = (function () {
    ...
    var cmds = {
        ...
        ABOUT: { value: "about", help: configs.getInstance().about },
        SKILLS: { value: "skills", help: configs.getInstance().skills },
        EXPERIENCES: { value: "experiences", help: configs.getInstance().experiences }
    };
        ...
        this.cmdLine.addEventListener("keydown", function (event) {
            if (event.which === 13 || event.keyCode === 13) {
                ...
                if(cmdHistory.length > 0){
                    this.cmdLine.value = cmdHistory[idx]; 
                    idx = idx -1;   
                } else {
                    this.cmdLine.value = cmdHistory[0];
                }
                ignoreEvent(event);
            }
        }.bind(this));
    ...
    Terminal.prototype.handleCmd = function () {
        var cmdComponents = this.cmdLine.value.trim().split(" ");
        cmdHistory.push(cmdComponents[0]);
        idx = cmdHistory.length - 1;
        ...
        switch (cmdComponents[0]) {
            ...
            this.about();
            break;
            case cmds.SKILLS.value:
            this.skills();
            break;
            case cmds.EXPERIENCES.value:
            this.experiences();
            break;
            case cmds.CD.value:
            case cmds.MV.value:
    ...
    Terminal.prototype.whoami = function (cmdComponents) {
        var result = 
        configs.getInstance().username + ": " + configs.getInstance().user + "\n" + 
    ...
    Terminal.prototype.about = function () {
        this.type(configs.getInstance().about, this.unlock.bind(this));
    };

    Terminal.prototype.skills = function () {
        this.type(configs.getInstance().skills, this.unlock.bind(this));
    };

    Terminal.prototype.experiences = function () {
        this.type(configs.getInstance().experiences, this.unlock.bind(this));
    };
